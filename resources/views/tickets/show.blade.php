        ...
        <div class="ticket-item">
          <div class="row">
            ...
            <div class="col-lg-4 col-sm-4 col-12 d-flex flex-column justify-content-center align-items-center buy-now-wrapper">
              <a href="{{ route('tickets.plans.order', ['id' => $plan->getId()]) }}" class="btn btn-primary buy-ticket"><i class="fa fa-ticket me-2"></i>{{ __('Buy Ticket for ') . '€' . number_format($plan->getPrice() / 100, 2) }}</a>
            </div>
          </div>
        </div>
        @endif
